...
\input{chapters/00_title_page.tex}
\newpage
    
\input{chapters/00_abstract_german.tex}
\newpage
...
\input{chapters/03_3_IV_characteristic_curve_and_STC.tex}
\subsection{An improved five-parameter model}
\input{chapters/03_4_An_improved_five_parameter_model.tex}
\label{sec:Five_parameter_model}
\subsection{Photovoltaic system modeling}
\input{chapters/03_5_Photovoltaic_system_modeling.tex}
...
\input{chapters/04_Application_and_analysis_of_the_model.tex}
\newpage
